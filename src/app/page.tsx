...
function ProfileImage() {
  return (
    <div className="h-72 w-72 rotate-[4deg] overflow-hidden rounded-base shadow-lg md:h-80 md:w-80 xl:h-96 xl:w-96">
      <Image
        src="/me3.jpg"
          ...
          <div className="flex flex-1 flex-col gap-10">
            ...
            <div className="flex items-center justify-center gap-4 lg:justify-start">
              ...
              {/* <a
                ...
                href={"https://github.com/rumanstheddy"}
                className={`rounded-base border-border shadow-nav dark:shadow-navDark dark:border-darkBorder flex size-16 items-center justify-center border-2 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none dark:hover:shadow-none`}
                // aria-label={ariaLabel}
              >
                <svg
                  className={`fill-foreground size-16`}
