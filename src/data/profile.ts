    ...
    experience: [
      {
        ...
        bullets: [
          ...
          "Optimized performance using code-splitting and lazy-loading strategies, reducing initial bundle size and improving Time to Interactive (TTI) by ~15%.",
          ...
          "Implemented secure authentication and authorization flows using OAuth 2.0 and JWT, integrating with Azure Active Directory to manage session handling, protected routes, and role-based access for sensitive treasury operations.",
          "Developed Django REST wrappers, increasing system maintainability ratings from 2/5 to 4/5.",
          ...
          "Automated CI/CD deployment workflows via Jenkins and Azure DevOps, achieving 100% release consistency across UAT/Production environments.",
